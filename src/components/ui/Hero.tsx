...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#4d7fff] to-[#2948ff]">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-8 pt-20 sm:pt-8 text-center">
        {/* Badge */}
        ...
        {/* Main heading */}
        <h1 className="font-satoshi-black text-4xl sm:text-5xl md:text-7xl lg:text-8xl tracking-tight text-white mb-6 animate-fade-in-up delay-100">
          Teach{" "}
        ...
        {/* Trust badges */}
        <div className="mt-12 mb-8 sm:mb-0 flex flex-wrap items-center justify-center gap-8 text-white/80 text-sm animate-fade-in-up delay-700">
